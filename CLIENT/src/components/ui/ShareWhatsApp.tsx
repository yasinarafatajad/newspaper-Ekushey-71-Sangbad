...
${url}`);
        ...
        const shareUrl = isMobile
            ? `whatsapp://send?text=${encodedMessage}` // mobile app
            : `https://web.whatsapp.com/send?text=${encodedMessage}`; // desktop web
    ...
    return (
        <button
            ...
            className="bg-green-500 hover:bg-green-600 rounded-full p-2 text-white transition-colors flex items-center justify-center"
